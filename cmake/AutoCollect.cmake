...
# Resolve all symlinks and add them to the list
# @param symlinks: list of symlinks
# @return resolved_links: content of "symlinks" + resolved paths
function(ResolveSymlinks symlinks resolved_links)
  foreach(_symlink IN LISTS symlinks)
    if(IS_SYMLINK ${_symlink})
      get_filename_component(_resolved_link ${_symlink} REALPATH)
      set(symlinks ${symlinks} ${_resolved_link})
    endif()
  endforeach()
  set(${resolved_links} ${symlinks} PARENT_SCOPE)
endfunction()
