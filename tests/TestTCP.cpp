...
//           requester.receiver.receive(response.size());
...
//     CHECK_THROWS_AS(
//         client.open(timeout),
//         Error); // linux throw if no server tcp were previously created,
//         while
...
//     // connect second client after accept unsuccess and check they can
//     exchange
//     // messages
//     parallel(
//         [&]() {
