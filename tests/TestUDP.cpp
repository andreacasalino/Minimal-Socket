...
// bool are_same(const Address &a, const Address &b, const AddressFamily
// &family) {
...
//           CHECK(are_same(received_response->sender, responder_address,
//           family));
//         }
//       },
//       [&]() {
...
//           CHECK(are_same(received_request->sender, requester_address,
//           family)); responder.sendTo(response, requester_address);
// #pragma omp barrier
//         }
//       });
...
// #pragma omp barrier
//             auto received_request = responder.receive(request.size(),
//             timeout); REQUIRE(received_request);
//             CHECK(received_request->received_message == request);
//             CHECK(
//                 are_same(received_request->sender, requester_address,
//                 family));
//           });
//     }
//   }
...
// #pragma omp barrier
//             auto received_request = responder.receive(request.size(),
//             timeout); CHECK(received_request == request);
//           });
//     }
//   }
// }
