...
//     auto connections =
//     sample::makeOpenedUdpConnections(sample::PortFactory::makePort(),
//     sample::PortFactory::makePort());
...
//     auto connections =
//     sample::makeOpenedUdpConnections(sample::PortFactory::makePort(),
//     sample::PortFactory::makePort()); const std::size_t cycles = 5;
...
//             std::make_unique<UdpServer>(portA);
...
//             std::make_unique<UdpConnection>(*sck::Ip::createLocalHost(portA)
//             , portB); connection->open(std::chrono::milliseconds(0));
