...
namespace sck {
   /**
    * @brief The address family. Refer to https://www.ibm.com/support/knowledgecenter/ssw_ibm_i_73/rzab6/address.htm
    */
   ...
   public:
      ...
      /**
       * @brief Internally the protocol Family is deduced according to the hostIp content.
       * @return nullptr if the host is invalid, otherwise a smart pointer storing a usable ip
       */
      static IpPtr create(const std::string& hostIp, const std::uint16_t& port);
